...
if __name__ == '__main__':
    ...
    hidden = keras.layers.Bidirectional(
        keras.layers.LSTM(hidden_dim // 2, recurrent_dropout=0.25, return_sequences=True))(embedded)
    hidden = keras.layers.Bidirectional(keras.layers.LSTM(hidden_dim // 2, recurrent_dropout=0.25))(hidden)
